 ...
 *
 * TODO: PC only so far, add .ogg support, add ingame gui config, validate music files and integrate exception handling
 *
 * @author MarviMarv
 */
public final class MusicManager {
	...
	public static void startMusic(ECivilisation civilisation, boolean playAll) {
	...
	private static String[] assembleMusicSet(ECivilisation civilisation, boolean playAll) {
